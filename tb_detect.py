...
test_set = test_datagen.flow_from_directory('dataset/test_set', target_size = (64, 64), batch_size =
32, class_mode = 'binary')
classifier.fit_generator(training_set, _per_epoch = 23, = 25, validation_data = test_set,
validation_steps = 2)
